...
public class RereplyInsertCommand implements ReplyCommand {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		replyDao.replyUpdatebGroupOrd(map2);
		...
		replyDao.rereplyInsert(r_writer, r_content, r_n_no, r_m_no, r_delete, r_group, r_groupOrd, r_depth);
